...
let cliente1: Cliente = new Cliente("Germán", "Rodriguez", 34000258, "Av.Siempre Viva 300", 1, 3)
console.log(cliente1);
let cliente2: Cliente = new ClienteVIP("Adrián", "Gutierrez", 36000895, "Av.Siempre Viva 524", 2, 6)
